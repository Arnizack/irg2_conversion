classdef DbBuilder
    ...
    methods
        ...
        function db = OpenCells(obj,patcher)
            ...
            csvTypes   ={'datetime','string','int32','string'            ,'int32'       ,'double'   ,'int32'              ,'int32'            ,'int32'                 ,'int32'               ,'int32'   ,'int32'  ,'int32','int32'               ,'double'          ,'double'               ,'char'  ,'string','string','string' };
        ...
        function db = OpenMonkeys(obj)
            ...
            db = CsvDatabase(path, ...
                            {'string'         ,'int32','datetime'        ,'double','string','string','double'}, ...
                            {'char'           ,'int32','datetime'        ,'double','char'  ,'char','double'},...
                            {'Monkey'         ,'Number','Date'           ,'Age','Sex'     ,'Species', 'Weight'}, ...
                            ';'...
                            );
        end
    end
